...
if (isset($_POST["add"])) {
  if (isset($_SESSION["cart"])) {
    $item_array_id = array_column($_SESSION["cart"], "id_buku");
...
if (isset($_GET["action"])) {
  if ($_GET["action"] == "delete") {
    ...
    foreach ($_SESSION["cart"] as $key => $value) {
      ...
      $sql = "INSERT INTO detail (id_transaksi,id_buku,qty) values ('$id_transaksi','$id_buku','$qty')";
      ...
      <tbody class="table-group-divider">
        ...
        ?>
            <tr>
              ...
              <td><a href="keranjang.php?action=delete&id=<?php echo $value["id_buku"]; ?>"></span class="text-danger">Hapus</span></a>
              </td>
            </tr>
          <?php
            $total = $total + ($value["item_quantity"] * $value["product_price"]);
          ...
          <tr>
            ...
            <td> <a href="keranjang.php?action=beli" class="btn btn-outline-success" type="submit" name="beli">checkout</a></td>
          </tr>
        <?php
